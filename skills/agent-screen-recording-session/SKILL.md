---
name: agent-screen-recording-session
description: Run bounded Agent Screen recordings with explicit audio and stop handling.
---

# Agent Screen recording session

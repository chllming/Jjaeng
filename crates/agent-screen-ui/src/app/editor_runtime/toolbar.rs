...
use agent_screen_core::editor::tools::CropPreset;
use agent_screen_core::editor::{self, ToolKind};
...
pub(super) fn build_tool_options_runtime(context: ToolOptionsBuildContext) -> ToolOptionsRuntime {
    ...
    let thickness_preview_rgb = match theme_mode {
        agent_screen_core::theme::ThemeMode::Light => (24_u8, 26_u8, 32_u8),
        agent_screen_core::theme::ThemeMode::Dark | agent_screen_core::theme::ThemeMode::System => {

...
use agent_screen_core::editor::tools::{CropElement, RectangleElement};
use agent_screen_core::editor::{self, ToolKind, ToolObject};
...
pub(in crate::app::editor_runtime) struct EditorDrawGestureContext {
    ...
    pub(in crate::app::editor_runtime) ocr_engine:
        Rc<RefCell<Option<agent_screen_core::ocr::OcrEngine>>>,
    pub(in crate::app::editor_runtime) ocr_language: agent_screen_core::ocr::OcrLanguage,
    ...
    *context.status_log_for_render.borrow_mut() =
    ...
    spawn_worker_action(
        move || {
            ...
            let result = agent_screen_core::ocr::recognize_text(&engine, &image);
            (Some(engine), result)
        },
        move |(engine, result): (

...
use agent_screen_core::editor::{self, EditorAction};
use agent_screen_core::input::{resolve_shortcut, InputContext, InputMode, ShortcutAction};
use agent_screen_core::state::{AppState, StateMachine};
...
fn open_editor_unsaved_close_dialog(
    ...
    *runtime.editor_close_dialog_open.borrow_mut() = true;
    ...
    dialog.add_css_class(agent_screen_core::identity::APP_CSS_ROOT);

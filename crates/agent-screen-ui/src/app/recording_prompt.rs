...
use agent_screen_core::identity::APP_CSS_ROOT;
use agent_screen_core::recording::{RecordingRequest, RecordingSelection, RecordingTarget};
use gtk4::gdk::Key;
use gtk4::prelude::*;
use gtk4::{
...
const RECORDING_PROMPT_TITLE: &str = "Agent Screen Recording Controls";
const RECORDING_SELECTION_TITLE: &str = "Agent Screen Recording Selection";

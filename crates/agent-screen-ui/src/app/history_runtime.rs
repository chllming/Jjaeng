...
use agent_screen_core::history::{HistoryEntry, HistoryService};
use agent_screen_core::notification;
...
const HISTORY_WINDOW_TITLE: &str = "Agent Screen History";
...
fn build_history_window(
    ...
    window.add_css_class(agent_screen_core::identity::APP_CSS_ROOT);

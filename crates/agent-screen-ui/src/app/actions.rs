...
use agent_screen_core::capture::CaptureArtifact;
use agent_screen_core::clipboard::ClipboardBackend;
use agent_screen_core::editor::{EditorAction, EditorActionError, EditorEvent};
use agent_screen_core::preview::{PreviewAction, PreviewActionError, PreviewEvent};
use agent_screen_core::storage::CaptureStorage;
...
mod tests {
    ...
    impl ClipboardBackend for FakeClipboard {
        fn copy(&self, path: &Path) -> agent_screen_core::clipboard::ClipboardResult<()> {
    ...
    impl CaptureStorage for FakeStorage {
        fn save_capture(
            &self,
            artifact: &CaptureArtifact,
        ) -> agent_screen_core::storage::StorageResult<PathBuf> {
            self.save_requests
                .borrow_mut()
        ...
        fn discard_session_artifacts(
            &self,
            capture_id: &str,
        ) -> agent_screen_core::storage::StorageResult<()> {

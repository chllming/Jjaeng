...
use agent_screen_core::editor::{self, EditorAction, ToolKind, ToolObject};
use agent_screen_core::history::HistoryService;
use agent_screen_core::state::StateMachine;
...
pub(super) struct EditorRenderContext {
    ...
    pub(super) theme_mode: agent_screen_core::theme::ThemeMode,
    ...
    pub(super) editor_navigation_bindings: Rc<agent_screen_core::input::EditorNavigationBindings>,
    ...
    pub(super) ocr_engine: Rc<RefCell<Option<agent_screen_core::ocr::OcrEngine>>>,
...
struct InitializedEditorRuntime {
    editor_navigation_bindings: Rc<agent_screen_core::input::EditorNavigationBindings>,

...
pub(super) struct EditorRenderContext {
    ...
    pub(super) editor_navigation_bindings: Rc<jjaeng_core::input::EditorNavigationBindings>,
...
struct InitializedEditorRuntime {
    editor_navigation_bindings: Rc<jjaeng_core::input::EditorNavigationBindings>,

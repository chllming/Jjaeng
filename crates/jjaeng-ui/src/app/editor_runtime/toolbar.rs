...
use jjaeng_core::editor::tools::CropPreset;
use jjaeng_core::editor::{self, ToolKind};
...
pub(super) struct ToolOptionsBuildContext {
    ...
    pub(super) theme_mode: jjaeng_core::theme::ThemeMode,
...
pub(super) fn build_tool_options_runtime(context: ToolOptionsBuildContext) -> ToolOptionsRuntime {
    ...
    let thickness_preview_rgb = match theme_mode {
        jjaeng_core::theme::ThemeMode::Light => (24_u8, 26_u8, 32_u8),
        jjaeng_core::theme::ThemeMode::Dark | jjaeng_core::theme::ThemeMode::System => {
